...
;------------------------------------------------------------------------------
IFileOpenDialogInit         PROTO pIFileOpenDialog:QWORD
IFileSaveDialogInit         PROTO pIFileSaveDialog:QWORD
IFileDialogInit             PROTO pIFileDialog:QWORD

IShellItemInit              PROTO pIShellItem:QWORD
IShellItemArrayInit         PROTO pIShellItemArray:QWORD

_FD_ConvertStringToAnsi     PROTO lpszWideString:QWORD
_FD_ConvertStringToWide     PROTO lpszAnsiString:QWORD
_FD_ConvertStringFree     PROTO lpString:QWORD
...
; IModalWindow
IModalWindow_Show_Proto                         TYPEDEF PROTO pThis:QWORD, hwndOwner:QWORD

; IFileDialog
IFileDialog_SetFileTypes_Proto                  TYPEDEF PROTO pThis:QWORD, cFileTypes:QWORD, rgFilterSpec:QWORD
IFileDialog_SetFileTypeIndex_Proto              TYPEDEF PROTO pThis:QWORD, iFileType:QWORD
IFileDialog_GetFileTypeIndex_Proto              TYPEDEF PROTO pThis:QWORD, piFileType:QWORD
IFileDialog_Advise_Proto                        TYPEDEF PROTO pThis:QWORD, pfde:QWORD, pqwCookie:QWORD
IFileDialog_Unadvise_Proto                      TYPEDEF PROTO pThis:QWORD, qwCookie:QWORD
IFileDialog_SetOptions_Proto                    TYPEDEF PROTO pThis:QWORD, fos:QWORD
IFileDialog_GetOptions_Proto                    TYPEDEF PROTO pThis:QWORD, pfos:QWORD
IFileDialog_SetDefaultFolder_Proto              TYPEDEF PROTO pThis:QWORD, psi:QWORD
IFileDialog_SetFolder_Proto                     TYPEDEF PROTO pThis:QWORD, psi:QWORD
IFileDialog_GetFolder_Proto                     TYPEDEF PROTO pThis:QWORD, ppsi:QWORD
IFileDialog_GetCurrentSelection_Proto           TYPEDEF PROTO pThis:QWORD, ppsi:QWORD
IFileDialog_SetFileName_Proto                   TYPEDEF PROTO pThis:QWORD, pszName:QWORD
IFileDialog_GetFileName_Proto                   TYPEDEF PROTO pThis:QWORD, pszName:QWORD
IFileDialog_SetTitle_Proto                      TYPEDEF PROTO pThis:QWORD, pszTitle:QWORD
IFileDialog_SetOkButtonLabel_Proto              TYPEDEF PROTO pThis:QWORD, pszText:QWORD
IFileDialog_SetFileNameLabel_Proto              TYPEDEF PROTO pThis:QWORD, pszLabel:QWORD
IFileDialog_GetResult_Proto                     TYPEDEF PROTO pThis:QWORD, ppsi:QWORD
IFileDialog_AddPlace_Proto                      TYPEDEF PROTO pThis:QWORD, psi:QWORD, fdap:QWORD
IFileDialog_SetDefaultExtension_Proto           TYPEDEF PROTO pThis:QWORD, pszDefaultExtension:QWORD
IFileDialog_Close_Proto                         TYPEDEF PROTO pThis:QWORD, hr:QWORD
IFileDialog_SetClientGuid_Proto                 TYPEDEF PROTO pThis:QWORD, guid:QWORD
IFileDialog_ClearClientData_Proto               TYPEDEF PROTO pThis:QWORD
IFileDialog_SetFilter_Proto                     TYPEDEF PROTO pThis:QWORD, pFilter:QWORD

; IFileSaveDialog
IFileSaveDialog_SetSaveAsItem_Proto             TYPEDEF PROTO pThis:QWORD, psi:QWORD
IFileSaveDialog_SetProperties_Proto             TYPEDEF PROTO pThis:QWORD, pStore:QWORD
IFileSaveDialog_SetCollectedProperties_Proto    TYPEDEF PROTO pThis:QWORD, pList:QWORD, fAppendDefault:QWORD
IFileSaveDialog_GetProperties_Proto             TYPEDEF PROTO pThis:QWORD, ppStore:QWORD
IFileSaveDialog_ApplyProperties_Proto           TYPEDEF PROTO pThis:QWORD, psi:QWORD, pStore:QWORD, hwnd:QWORD, pSink:QWORD

; IFileOpenDialog
IFileOpenDialog_GetResults_Proto                TYPEDEF PROTO pThis:QWORD, ppenum:QWORD
IFileOpenDialog_GetSelectedItems_Proto          TYPEDEF PROTO pThis:QWORD, ppsai:QWORD

; IFileDialogEvents
IFileDialogEvents_OnFileOk_Proto                TYPEDEF PROTO pThis:QWORD, pfd:QWORD
IFileDialogEvents_OnFolderChanging_Proto        TYPEDEF PROTO pThis:QWORD, pfd:QWORD, psiFolder:QWORD
IFileDialogEvents_OnFolderChange_Proto          TYPEDEF PROTO pThis:QWORD, pfd:QWORD
IFileDialogEvents_OnSelectionChange_Proto       TYPEDEF PROTO pThis:QWORD, pfd:QWORD
IFileDialogEvents_OnShareViolation_Proto        TYPEDEF PROTO pThis:QWORD, pfd:QWORD, psi:QWORD, pResponse:QWORD
IFileDialogEvents_OnTypeChange_Proto            TYPEDEF PROTO pThis:QWORD, pfd:QWORD
IFileDialogEvents_OnOverwrite_Proto             TYPEDEF PROTO pThis:QWORD, pfd:QWORD, psi:QWORD, pResponse:QWORD

; IShellItem
IShellItem_BindToHandler_Proto                  TYPEDEF PROTO pThis:QWORD, pbc:QWORD, bhid:QWORD, riid:QWORD, ppvOut:QWORD
IShellItem_GetParent_Proto                      TYPEDEF PROTO pThis:QWORD, ppsi:QWORD
IShellItem_GetDisplayName_Proto                 TYPEDEF PROTO pThis:QWORD, sigdnName:QWORD, ppszName:QWORD
IShellItem_GetAttributes_Proto                  TYPEDEF PROTO pThis:QWORD, sfgaoMask:QWORD, psfgaoAttribs:QWORD
IShellItem_Compare_Proto                        TYPEDEF PROTO pThis:QWORD, psi:QWORD, hint:QWORD, piOrder:QWORD

; IShellItemArray
IShellItemArray_BindToHandler_Proto             TYPEDEF PROTO pThis:QWORD, pbc:QWORD, bhid:QWORD, riid:QWORD, ppvOut:QWORD
IShellItemArray_GetPropertyStore_Proto          TYPEDEF PROTO pThis:QWORD, flags:QWORD, riid:QWORD, ppv:QWORD
IShellItemArray_GetPropertyDescriptionList_Proto TYPEDEF PROTO pThis:QWORD, keyType:QWORD, riid:QWORD, ppv:QWORD
IShellItemArray_GetAttributes_Proto             TYPEDEF PROTO pThis:QWORD, AttribFlags:QWORD, sfgaoMask:QWORD, psfgaoAttribs:QWORD
IShellItemArray_GetCount_Proto                  TYPEDEF PROTO pThis:QWORD, pqwNumItems:QWORD
IShellItemArray_GetItemAt_Proto                 TYPEDEF PROTO pThis:QWORD, qwIndex:QWORD, ppsi:QWORD
IShellItemArray_EnumItems_Proto                 TYPEDEF PROTO pThis:QWORD, ppenumShellItems:QWORD
...
IFileDialogEventsVtbl   STRUCT 8
    QueryInterface      IUnknown_QueryInterface_Ptr 0
    AddRef              IUnknown_AddRef_Ptr 0
    Release             IUnknown_Release_Ptr 0
...
FILEOPENDIALOGOPTIONS       TYPEDEF QWORD
...
; 
;------------------------------------------------------------------------------
FileOpenDialogA PROC FRAME USES RBX lpszTitle:QWORD, lpszOkLabel:QWORD, lpszFileLabel:QWORD, lpszFolder:QWORD, nMFS:QWORD, pMFS:QWORD, hWndOwner:QWORD, bMulti:QWORD, lpqwFiles:QWORD, lpFilesArray:QWORD
    LOCAL pIFOD:QWORD       ; pointer to IFileOpenDialog
    LOCAL pISIA:QWORD       ; pointer to IShellItemArray
    LOCAL pISI:QWORD        ; pointer to IShellItem
    LOCAL pISIF:QWORD       ; pointer to IShellItem for lpszFolder
    LOCAL qwOptions:QWORD
    LOCAL qwFileCount:QWORD
    LOCAL nCount:QWORD
    LOCAL pFileArray:QWORD
    LOCAL pFileName:QWORD
    LOCAL qwFileNameLength:QWORD
    LOCAL qwFileArraySize:QWORD
    LOCAL nPos:QWORD
    LOCAL lpszWideTitle:QWORD
    LOCAL lpszWideOkLabel:QWORD
    LOCAL lpszWideFileLabel:QWORD
    LOCAL lpszWideFolder:QWORD
    LOCAL pWideMFS:QWORD
    LOCAL pCurFileSpecSrc:QWORD
    LOCAL pCurFileSpecDest:QWORD
    LOCAL lpszString:QWORD
    LOCAL qwReturnResult:QWORD
    
    .IF lpqwFiles == 0 || lpFilesArray == 0
        mov rax, FALSE
        ret
    .ENDIF
    ...
    .IF pMFS != NULL && nMFS != 0
        ...
        mov rax, nMFS
        mov rbx, SIZEOF COMDLG_FILTERSPEC
        mul rbx
        ...
        mov rax, pWideMFS
        mov pCurFileSpecDest, rax
        mov rax, pMFS
        mov pCurFileSpecSrc, rax
        
        mov nCount, 0
        mov rax, 0
        .WHILE rax < nMFS
            mov rbx, pCurFileSpecSrc
            mov rax, [rbx].COMDLG_FILTERSPEC.pszName
            mov lpszString, rax
            Invoke _FD_ConvertStringToWide, lpszString
           
            mov rbx, pCurFileSpecDest
            mov [rbx].COMDLG_FILTERSPEC.pszName, rax
            
            mov rbx, pCurFileSpecSrc
            mov rax, [rbx].COMDLG_FILTERSPEC.pszSpec
            mov lpszString, rax
            Invoke _FD_ConvertStringToWide, lpszString
            
            mov rbx, pCurFileSpecDest
            mov [rbx].COMDLG_FILTERSPEC.pszSpec, rax
    ...
    ;--------------------------------------------------------------------------
    mov qwOptions, FOS_FORCEFILESYSTEM or FOS_FORCESHOWHIDDEN
    .IF bMulti == TRUE
        or qwOptions, FOS_ALLOWMULTISELECT
    .ENDIF
    Invoke IFileOpenDialog_SetOptions, pIFOD, qwOptions
    .IF rax != S_OK
        IFDEF DEBUG64
    ...
    .IF rax == HRESULT_ERROR_CANCELLED
        IFDEF DEBUG64
        PrintText 'FileOpenDialogA Cancelled'
        ENDIF
        mov qwReturnResult, TRUE
        jmp FileOpenDialogA_Exit
    .ELSEIF rax != S_OK
        IFDEF DEBUG64
    ...
    Invoke IShellItemArray_GetCount, pISIA, Addr qwFileCount
    
    .IF qwFileCount != 0
        
        IFDEF DEBUG64
        PrintDec qwFileCount
        ENDIF
        ...
        mov nCount, 0
        xor rbx, rbx
        .WHILE rbx < qwFileCount    
            
            ; Get filename in each item in the results array 
            Invoke IShellItemArray_GetItemAt, pISIA, rbx, Addr pISI
            mov rax, pISI
            mov rbx, [rax]
            Invoke [rbx].IShellItemVtbl.GetDisplayName, pISI, SIGDN_FILESYSPATH, Addr pFileName
            
            Invoke lstrlenW, pFileName
            ;shl rax, 1 ; x2 for unicode chars to bytes
            add rax, 1 ; for null terminator
            add qwFileArraySize, rax
            
            Invoke CoTaskMemFree, pFileName
            
            mov rax, pISI
            mov rbx, [rax]
            Invoke [rbx].IShellItemVtbl.Release, pISI
            
            inc nCount
            mov rbx, nCount
        .ENDW
        add qwFileArraySize, 1 ; for double null
        
        ;----------------------------------------------------------------------
        ; Allocate memory for filename array
        ;----------------------------------------------------------------------
        mov rax, qwFileArraySize
        add rax, 8 ; just in case
        Invoke GlobalAlloc, GMEM_FIXED or GMEM_ZEROINIT, rax
        .IF rax == NULL
            jmp FileOpenDialogA_Exit
        .ENDIF
        ...
        .WHILE rbx < qwFileCount    
            ...
            mov qwFileNameLength, rax
            
            mov rbx, pFileArray
            add rbx, nPos
            Invoke RtlMoveMemory, rbx, lpszString, qwFileNameLength
        ...
        IFDEF DEBUG64
        DbgDump pFileArray, qwFileArraySize
        ENDIF
...
FileOpenDialogA_Exit:
    ...
    .IF pISIF != 0
        mov rax, pISIF
        mov rbx, [rax]
        Invoke [rbx].IShellItemVtbl.Release, pISIF
    .ENDIF
    ...
    .IF lpFilesArray != 0
        mov rbx, lpFilesArray
        mov rax, pFileArray
        mov [rbx], rax
    .ENDIF
    
    Invoke CoUninitialize
    mov rax, qwReturnResult
...
; * bMulti - allow multiple file selection (TRUE) or single file only (FALSE)
;
; * lpqwFiles - pointer to a variable that stores the number of files that the
;   user selected to 'open' and the number of files in the lpFilesArray array 
;   of filenames.   
...
; 
;------------------------------------------------------------------------------
FileOpenDialogW PROC FRAME USES RBX lpszTitle:QWORD, lpszOkLabel:QWORD, lpszFileLabel:QWORD, lpszFolder:QWORD, nMFS:QWORD, pMFS:QWORD, hWndOwner:QWORD, bMulti:QWORD, lpqwFiles:QWORD, lpFilesArray:QWORD
    LOCAL pIFOD:QWORD       ; pointer to IFileOpenDialog
    LOCAL pISIA:QWORD       ; pointer to IShellItemArray
    LOCAL pISI:QWORD        ; pointer to IShellItem
    LOCAL pISIF:QWORD       ; pointer to IShellItem for lpszFolder
    ...
    .IF qwFileCount != 0
        ...
        .WHILE rbx < qwFileCount    
            ...
            mov rbx, nCount
        .ENDW
        add qwFileArraySize, 2 ; for double null
        ...
        .WHILE rbx < qwFileCount    
            ...
            mov rbx, pFileArray
            add rbx, nPos
            Invoke RtlMoveMemory, rbx, pFileName, qwFileNameLength
...
;
; * lpqwSaveFile - pointer to a variable that stores a pointer to a string
...
; are expected to be Ansi strings, and the return results are stored in the
; lpqwSaveFile parameter as a pointer to an Ansi string.
;
...
; 
;------------------------------------------------------------------------------
FileSaveDialogA PROC FRAME USES RBX lpszTitle:QWORD, lpszOkLabel:QWORD, lpszFileLabel:QWORD, lpszFolder:QWORD, nMFS:QWORD, pMFS:QWORD, hWndOwner:QWORD, bWarn:QWORD, lpszFileName:QWORD, lpqwSaveFile:QWORD
    LOCAL pIFSD:QWORD       ; pointer to IFileSaveDialog
    LOCAL pISI:QWORD        ; pointer to IShellItem
    LOCAL pISIF:QWORD       ; pointer to IShellItem for lpszFolder
    LOCAL pISISAI:QWORD     ; pointer to IShellItem SaveAsItem for lpszInitialFile
    LOCAL qwOptions:QWORD
    LOCAL nCount:QWORD
    LOCAL pFileName:QWORD
    LOCAL lpszAnsiFileName:QWORD
    LOCAL qwFileNameLength:QWORD
    LOCAL lpszWideTitle:QWORD
    LOCAL lpszWideOkLabel:QWORD
    LOCAL lpszWideFileLabel:QWORD
    LOCAL lpszWideFolder:QWORD
    LOCAL lpszWideFile:QWORD
    LOCAL pWideMFS:QWORD
    LOCAL pCurFileSpecSrc:QWORD
    LOCAL pCurFileSpecDest:QWORD
    LOCAL lpszString:QWORD
    ...
    mov qwOptions, FOS_FORCEFILESYSTEM or FOS_FORCESHOWHIDDEN
    .IF bWarn == TRUE
        or qwOptions, FOS_OVERWRITEPROMPT
    .ENDIF
    Invoke IFileSaveDialog_SetOptions, pIFSD, qwOptions
    .IF rax != S_OK
        IFDEF DEBUG64
...
FileSaveDialogA_Exit:
    ...
    ;--------------------------------------------------------------------------
    .IF lpqwSaveFile != 0
        mov rbx, lpqwSaveFile
        mov rax, lpszAnsiFileName
        mov [rbx], rax
    .ENDIF
...
; * lpszFileName - pointer to a string for the initial filename to use.
;
; * lpszInitialFile - pointer to a string for the initial filename to use.
;
; * lpqwSaveFile - pointer to a variable that stores a pointer to a string
;   containting the save filename to use.
;
...
; parameters are expected to be Wide/Unicode strings, and the return results 
; are stored in the lpqwSaveFile parameter as a pointer to a Wide string.
;
...
; 
;------------------------------------------------------------------------------
FileSaveDialogW PROC FRAME USES RBX lpszTitle:QWORD, lpszOkLabel:QWORD, lpszFileLabel:QWORD, lpszFolder:QWORD, nMFS:QWORD, pMFS:QWORD, hWndOwner:QWORD, bWarn:QWORD, lpszFileName:QWORD, lpqwSaveFile:QWORD
    LOCAL pIFSD:QWORD       ; pointer to IFileSaveDialog
    LOCAL pISI:QWORD        ; pointer to IShellItem
    LOCAL pISIF:QWORD       ; pointer to IShellItem for lpszFolder
    LOCAL pISISAI:QWORD     ; pointer to IShellItem SaveAsItem for lpszInitialFile
    LOCAL qwOptions:QWORD
    LOCAL pFileName:QWORD
    LOCAL pWideFileName:QWORD
    LOCAL qwWideFileNameLength:QWORD
    LOCAL qwReturnResult:QWORD
    ...
    .IF rax == S_OK
        ...
        Invoke lstrlenW, pFileName
        shl rax, 1 ; x2 for unicode chars to bytes
        mov qwWideFileNameLength, rax
        add rax, 8 ; just in case
        Invoke GlobalAlloc, GMEM_FIXED or GMEM_ZEROINIT, rax
        .IF rax == NULL
            jmp FileSaveDialogW_Exit
        .ENDIF
        mov pWideFileName, rax
        
        Invoke RtlMoveMemory, pWideFileName, pFileName, qwWideFileNameLength
    ...
    shl rax, 1 ; x2 for unicode to bytes
    DbgDump pWideFileName, rax
    ENDIF
...
FileSaveDialogW_Exit:
    ...
    .IF pISISAI != 0
        mov rax, pISISAI
        mov rbx, [rax]
        Invoke [rbx].IShellItemVtbl.Release, pISISAI
    .ENDIF
...
;
; * lpqwFolder - pointer to a variable thats stores a pointer to a string 
...
; in the lpqwFolder parameter as a pointer to an Ansi string.
;
...
; 
;------------------------------------------------------------------------------
FolderSelectDialogA PROC FRAME USES RBX lpszTitle:QWORD, lpszOkLabel:QWORD, lpszFileLabel:QWORD, lpszFolder:QWORD, hWndOwner:QWORD, lpqwFolder:QWORD
    LOCAL pIFD:QWORD        ; pointer to IFileDialog
    LOCAL pISI:QWORD        ; pointer to IShellItem
    LOCAL pISIF:QWORD       ; pointer to IShellItem for lpszFolder
    LOCAL qwOptions:QWORD
    LOCAL pFolder:QWORD
    LOCAL lpszAnsiFolder:QWORD
    LOCAL lpszWideTitle:QWORD
    LOCAL lpszWideOkLabel:QWORD
    LOCAL lpszWideFileLabel:QWORD
    LOCAL lpszWideFolder:QWORD
    ...
    ; Set options: 
    ;--------------------------------------------------------------------------
    mov qwOptions, FOS_FORCEFILESYSTEM or FOS_FORCESHOWHIDDEN or FOS_PICKFOLDERS
    Invoke IFileDialog_SetOptions, pIFD, qwOptions
    .IF rax != S_OK
        IFDEF DEBUG64
    ...
    mov rax, pISI
    mov rbx, [rax]
    Invoke [rbx].IShellItemVtbl.GetDisplayName, pISI, SIGDN_FILESYSPATH, Addr pFolder
    
    Invoke _FD_ConvertStringToAnsi, pFolder
    mov lpszAnsiFolder, rax
...
; parameters are expected to be Wide/Unicode strings, and the return results 
; are stored in the lpqwFolder parameter as a pointer to a Wide/Unicode string.
;
...
; 
;------------------------------------------------------------------------------
FolderSelectDialogW PROC FRAME USES RBX lpszTitle:QWORD, lpszOkLabel:QWORD, lpszFileLabel:QWORD, lpszFolder:QWORD, hWndOwner:QWORD, lpqwFolder:QWORD
    LOCAL pIFD:QWORD        ; pointer to IFileDialog
    LOCAL pISI:QWORD        ; pointer to IShellItem
    LOCAL pISIF:QWORD       ; pointer to IShellItem for lpszFolder
    LOCAL qwOptions:QWORD
    LOCAL pFolder:QWORD
    LOCAL pWideFolder:QWORD
    LOCAL qwWideFolderLength:QWORD
    LOCAL qwReturnResult:QWORD
    ...
    Invoke RtlMoveMemory, pWideFolder, pFolder, qwWideFolderLength
...
; 
;------------------------------------------------------------------------------
IFileOpenDialogInit PROC FRAME USES RBX ppIFileOpenDialog:QWORD
    LOCAL pfd:QWORD
    ...
    .IF rbx == 0
        IFDEF DEBUG64
        PrintText 'IFileOpenDialogInit pfd::rbx == 0'
        ENDIF
        jmp IFileOpenDialogInit_Error
    .ENDIF
    
    mov rax, [rbx].IFileOpenDialogVtbl.QueryInterface
    mov IFileOpenDialog_QueryInterface, rax
    mov rax, [rbx].IFileOpenDialogVtbl.AddRef
    mov IFileOpenDialog_AddRef, rax
    mov rax, [rbx].IFileOpenDialogVtbl.Release
    mov IFileOpenDialog_Release, rax
    mov rax, [rbx].IFileOpenDialogVtbl.Show
    mov IFileOpenDialog_Show, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetFileTypes
    mov IFileOpenDialog_SetFileTypes, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetFileTypeIndex
    mov IFileOpenDialog_SetFileTypeIndex, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetFileTypeIndex
    mov IFileOpenDialog_GetFileTypeIndex, rax
    mov rax, [rbx].IFileOpenDialogVtbl.Advise
    mov IFileOpenDialog_Advise, rax
    mov rax, [rbx].IFileOpenDialogVtbl.Unadvise
    mov IFileOpenDialog_Unadvise, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetOptions
    mov IFileOpenDialog_SetOptions, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetOptions
    mov IFileOpenDialog_GetOptions, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetDefaultFolder
    mov IFileOpenDialog_SetDefaultFolder, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetFolder
    mov IFileOpenDialog_SetFolder, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetFolder
    mov IFileOpenDialog_GetFolder, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetCurrentSelection
    mov IFileOpenDialog_GetCurrentSelection, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetFileName
    mov IFileOpenDialog_SetFileName, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetFileName
    mov IFileOpenDialog_GetFileName, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetTitle
    mov IFileOpenDialog_SetTitle, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetOkButtonLabel
    mov IFileOpenDialog_SetOkButtonLabel, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetFileNameLabel
    mov IFileOpenDialog_SetFileNameLabel, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetResult
    mov IFileOpenDialog_GetResult, rax
    mov rax, [rbx].IFileOpenDialogVtbl.AddPlace
    mov IFileOpenDialog_AddPlace, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetDefaultExtension
    mov IFileOpenDialog_SetDefaultExtension, rax
    mov rax, [rbx].IFileOpenDialogVtbl.Close
    mov IFileOpenDialog_Close, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetClientGuid
    mov IFileOpenDialog_SetClientGuid, rax
    mov rax, [rbx].IFileOpenDialogVtbl.ClearClientData
    mov IFileOpenDialog_ClearClientData, rax
    mov rax, [rbx].IFileOpenDialogVtbl.SetFilter
    mov IFileOpenDialog_SetFilter, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetResults
    mov IFileOpenDialog_GetResults, rax
    mov rax, [rbx].IFileOpenDialogVtbl.GetSelectedItems
    mov IFileOpenDialog_GetSelectedItems, rax
...
; 
;------------------------------------------------------------------------------
IFileSaveDialogInit PROC FRAME USES RBX ppIFileSaveDialog:QWORD
    LOCAL pfd:QWORD
    ...
    .IF rbx == 0
        IFDEF DEBUG64
        PrintText 'IFileSaveDialogInit pfd::rbx == 0'
        ENDIF
        jmp IFileSaveDialogInit_Error
    .ENDIF
    
    mov rax, [rbx].IFileSaveDialogVtbl.QueryInterface
    mov IFileSaveDialog_QueryInterface, rax
    mov rax, [rbx].IFileSaveDialogVtbl.AddRef
    mov IFileSaveDialog_AddRef, rax
    mov rax, [rbx].IFileSaveDialogVtbl.Release
    mov IFileSaveDialog_Release, rax
    mov rax, [rbx].IFileSaveDialogVtbl.Show
    mov IFileSaveDialog_Show, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetFileTypes
    mov IFileSaveDialog_SetFileTypes, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetFileTypeIndex
    mov IFileSaveDialog_SetFileTypeIndex, rax
    mov rax, [rbx].IFileSaveDialogVtbl.GetFileTypeIndex
    mov IFileSaveDialog_GetFileTypeIndex, rax
    mov rax, [rbx].IFileSaveDialogVtbl.Advise
    mov IFileSaveDialog_Advise, rax
    mov rax, [rbx].IFileSaveDialogVtbl.Unadvise
    mov IFileSaveDialog_Unadvise, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetOptions
    mov IFileSaveDialog_SetOptions, rax
    mov rax, [rbx].IFileSaveDialogVtbl.GetOptions
    mov IFileSaveDialog_GetOptions, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetDefaultFolder
    mov IFileSaveDialog_SetDefaultFolder, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetFolder
    mov IFileSaveDialog_SetFolder, rax
    mov rax, [rbx].IFileSaveDialogVtbl.GetFolder
    mov IFileSaveDialog_GetFolder, rax
    mov rax, [rbx].IFileSaveDialogVtbl.GetCurrentSelection
    mov IFileSaveDialog_GetCurrentSelection, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetFileName
    mov IFileSaveDialog_SetFileName, rax
    mov rax, [rbx].IFileSaveDialogVtbl.GetFileName
    mov IFileSaveDialog_GetFileName, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetTitle
    mov IFileSaveDialog_SetTitle, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetOkButtonLabel
    mov IFileSaveDialog_SetOkButtonLabel, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetFileNameLabel
    mov IFileSaveDialog_SetFileNameLabel, rax
    mov rax, [rbx].IFileSaveDialogVtbl.GetResult
    mov IFileSaveDialog_GetResult, rax
    mov rax, [rbx].IFileSaveDialogVtbl.AddPlace
    mov IFileSaveDialog_AddPlace, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetDefaultExtension
    mov IFileSaveDialog_SetDefaultExtension, rax
    mov rax, [rbx].IFileSaveDialogVtbl.Close
    mov IFileSaveDialog_Close, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetClientGuid
    mov IFileSaveDialog_SetClientGuid, rax
    mov rax, [rbx].IFileSaveDialogVtbl.ClearClientData
    mov IFileSaveDialog_ClearClientData, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetFilter
    mov IFileSaveDialog_SetFilter, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetSaveAsItem
    mov IFileSaveDialog_SetSaveAsItem, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetProperties
    mov IFileSaveDialog_SetProperties, rax
    mov rax, [rbx].IFileSaveDialogVtbl.SetCollectedProperties
    mov IFileSaveDialog_SetCollectedProperties, rax
    mov rax, [rbx].IFileSaveDialogVtbl.GetProperties
    mov IFileSaveDialog_GetProperties, rax
    mov rax, [rbx].IFileSaveDialogVtbl.ApplyProperties
    mov IFileSaveDialog_ApplyProperties, rax
...
; 
;------------------------------------------------------------------------------
IFileDialogInit PROC FRAME USES RBX ppIFileDialog:QWORD
    LOCAL pfd:QWORD
    ...
    .IF rbx == 0
        IFDEF DEBUG64
        PrintText 'IFileDialogInit pfd::rbx == 0'
        ENDIF
        jmp IFileDialogInit_Error
    .ENDIF
    
    mov rax, [rbx].IFileDialogVtbl.QueryInterface
    mov IFileSaveDialog_QueryInterface, rax
    mov rax, [rbx].IFileDialogVtbl.AddRef
    mov IFileDialog_AddRef, rax
    mov rax, [rbx].IFileDialogVtbl.Release
    mov IFileDialog_Release, rax
    mov rax, [rbx].IFileDialogVtbl.Show
    mov IFileDialog_Show, rax
    mov rax, [rbx].IFileDialogVtbl.SetFileTypes
    mov IFileDialog_SetFileTypes, rax
    mov rax, [rbx].IFileDialogVtbl.SetFileTypeIndex
    mov IFileDialog_SetFileTypeIndex, rax
    mov rax, [rbx].IFileDialogVtbl.GetFileTypeIndex
    mov IFileDialog_GetFileTypeIndex, rax
    mov rax, [rbx].IFileDialogVtbl.Advise
    mov IFileDialog_Advise, rax
    mov rax, [rbx].IFileDialogVtbl.Unadvise
    mov IFileDialog_Unadvise, rax
    mov rax, [rbx].IFileDialogVtbl.SetOptions
    mov IFileDialog_SetOptions, rax
    mov rax, [rbx].IFileDialogVtbl.GetOptions
    mov IFileDialog_GetOptions, rax
    mov rax, [rbx].IFileDialogVtbl.SetDefaultFolder
    mov IFileDialog_SetDefaultFolder, rax
    mov rax, [rbx].IFileDialogVtbl.SetFolder
    mov IFileDialog_SetFolder, rax
    mov rax, [rbx].IFileDialogVtbl.GetFolder
    mov IFileDialog_GetFolder, rax
    mov rax, [rbx].IFileDialogVtbl.GetCurrentSelection
    mov IFileDialog_GetCurrentSelection, rax
    mov rax, [rbx].IFileDialogVtbl.SetFileName
    mov IFileDialog_SetFileName, rax
    mov rax, [rbx].IFileDialogVtbl.GetFileName
    mov IFileDialog_GetFileName, rax
    mov rax, [rbx].IFileDialogVtbl.SetTitle
    mov IFileDialog_SetTitle, rax
    mov rax, [rbx].IFileDialogVtbl.SetOkButtonLabel
    mov IFileDialog_SetOkButtonLabel, rax
    mov rax, [rbx].IFileDialogVtbl.SetFileNameLabel
    mov IFileDialog_SetFileNameLabel, rax
    mov rax, [rbx].IFileDialogVtbl.GetResult
    mov IFileDialog_GetResult, rax
    mov rax, [rbx].IFileDialogVtbl.AddPlace
    mov IFileDialog_AddPlace, rax
    mov rax, [rbx].IFileDialogVtbl.SetDefaultExtension
    mov IFileDialog_SetDefaultExtension, rax
    mov rax, [rbx].IFileDialogVtbl.Close
    mov IFileDialog_Close, rax
    mov rax, [rbx].IFileDialogVtbl.SetClientGuid
    mov IFileDialog_SetClientGuid, rax
    mov rax, [rbx].IFileDialogVtbl.ClearClientData
    mov IFileDialog_ClearClientData, rax
    mov rax, [rbx].IFileDialogVtbl.SetFilter
    mov IFileDialog_SetFilter, rax
...
; 
;------------------------------------------------------------------------------
IShellItemInit PROC FRAME USES RBX pIShellItem:QWORD
    ...
    .IF rbx == 0
        IFDEF DEBUG64
        PrintText 'IShellItemInit psi::rbx == 0'
        ENDIF
        jmp IShellItemInit_Error
    .ENDIF
    
    mov rax, [rbx].IShellItemVtbl.QueryInterface
    mov IShellItem_QueryInterface, rax
    mov rax, [rbx].IShellItemVtbl.AddRef
    mov IShellItem_AddRef, rax
    mov rax, [rbx].IShellItemVtbl.Release
    mov IShellItem_Release, rax
    mov rax, [rbx].IShellItemVtbl.BindToHandler
    mov IShellItem_BindToHandler, rax
    mov rax, [rbx].IShellItemVtbl.GetParent
    mov IShellItem_GetParent, rax
    mov rax, [rbx].IShellItemVtbl.GetDisplayName
    mov IShellItem_GetDisplayName, rax
    mov rax, [rbx].IShellItemVtbl.GetAttributes
    mov IShellItem_GetAttributes, rax
    mov rax, [rbx].IShellItemVtbl.Compare
    mov IShellItem_Compare, rax
...
; 
;------------------------------------------------------------------------------
IShellItemArrayInit PROC FRAME USES RBX pIShellItemArray:QWORD
    ...
    ; Get functions:
    mov rax, pIShellItemArray
    mov rbx, [rax]
    .IF rbx == 0
        IFDEF DEBUG64
        PrintText 'IShellItemArrayInit psi::rbx == 0'
        ENDIF
        jmp IShellItemArrayInit_Error
    .ENDIF
    
    mov rax, [rbx].IShellItemArrayVtbl.QueryInterface
    mov IShellItemArray_QueryInterface, rax
    mov rax, [rbx].IShellItemArrayVtbl.AddRef
    mov IShellItemArray_AddRef, rax
    mov rax, [rbx].IShellItemArrayVtbl.Release
    mov IShellItemArray_Release, rax
    mov rax, [rbx].IShellItemArrayVtbl.BindToHandler
    mov IShellItemArray_BindToHandler, rax
    mov rax, [rbx].IShellItemArrayVtbl.GetPropertyStore
    mov IShellItemArray_GetPropertyStore, rax
    mov rax, [rbx].IShellItemArrayVtbl.GetPropertyDescriptionList
    mov IShellItemArray_GetPropertyDescriptionList, rax
    mov rax, [rbx].IShellItemArrayVtbl.GetAttributes
    mov IShellItemArray_GetAttributes, rax
    mov rax, [rbx].IShellItemArrayVtbl.GetCount
    mov IShellItemArray_GetCount, rax
    mov rax, [rbx].IShellItemArrayVtbl.GetItemAt
    mov IShellItemArray_GetItemAt, rax
    mov rax, [rbx].IShellItemArrayVtbl.EnumItems
    mov IShellItemArray_EnumItems, rax
...
; 
;------------------------------------------------------------------------------
_FD_ConvertStringToAnsi PROC FRAME lpszWideString:QWORD
...
; 
;------------------------------------------------------------------------------
_FD_ConvertStringToWide PROC FRAME lpszAnsiString:QWORD
...
; 
;------------------------------------------------------------------------------
_FD_ConvertStringFree PROC FRAME lpString:QWORD
    mov rax, lpString
    .IF rax == NULL
        mov rax, FALSE
        ret
